...
A framework for solving the Cloud Container Orchestration Problem (CCOP) using heuristics and metaheuristics. It applies operations research and cloud optimization techniques to efficiently deploy containers on physical servers.
